...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.parentEl = 'body';
//      this.parentEl = 'div.function-body';

        //element that triggered the date range picker
        this.element = $(element);

        //create the picker HTML object
        var DRPTemplate = '<div class="daterangepicker dropdown-menu" id="daterangepicker">' +
            '<div class="ranges">' +
            '</div>' +
        ...
        this.container.find('.xy-btn-group')
            .on('click.daterangepicker', 'button.applyBtn', $.proxy(this.clickApply, this))
            .on('click.daterangepicker', 'button.cancelBtn', $.proxy(this.clickCancel, this));
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function (options, callback) {
            ...
            this.opens = 'right';
            if (this.element.hasClass('xy-pull-right'))
                this.opens = 'left';

            this.buttonClasses = ['xy-btn', 'xy-btn-small'];
            this.applyClass = 'xy-btn-success';
            this.cancelClass = 'xy-btn-default';
        ...
        hideCalendars: function () {
            this.container.removeClass('show-calendar'); //是否隐藏日期选择
        },
