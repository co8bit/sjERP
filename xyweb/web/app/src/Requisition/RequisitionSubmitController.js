...
angular.module('XY').controller('RequisitionSubmitController', ['EventService', '$scope', '$log', 'RequisitionModel', 'StockService', 'UserService', '$timeout', 'LockService', 'PageService',
	function (EventService, $scope, $log, model, StockService, UserService, $timeout, LockService, PageService) {
		...
		//测试使用 仓库集合
			$scope.warehouse = ['主仓库','A仓库','B仓库'];
		//时间选择器
     $scope.reg_time = new Date().toLocaleDateString();
     // 使用jqUI
     $(function () {
