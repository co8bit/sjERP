...
abstract class Driver {
    ...
    {
        if (empty($methodName))
            \Think\Log::record(__ACTION__.'======>'.'startTrans()','DEBUG');
        else
            \Think\Log::record($methodName.'======>'.'startTrans()','DEBUG');
    ...
    {
        if (empty($methodName))
            \Think\Log::record(__ACTION__.'======>'.'commit()','DEBUG');
        else
            \Think\Log::record($methodName.'======>'.'commit()','DEBUG');
    ...
    {
         if (empty($methodName))
            \Think\Log::record(__ACTION__.'======>'.'rollback()','DEBUG');
        else
            \Think\Log::record($methodName.'======>'.'rollback()','DEBUG');
    ...
    public function error() {
        ...
        if($this->config['debug']) {// 开启数据库调试模式
            // dump($this->error);
            if ( ($this->error[0] == 1) && ($this->error[1] == 6) && ($this->error[2] == 9) && ($this->error[3] == 0) )
                ;
            else
                E($this->error);
        }else{
